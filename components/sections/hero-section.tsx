...
export function HeroSection() {
  ...
  return (
    <section
      id="hero"
      ref={containerRef}
      className="relative min-h-[calc(100vh)] flex flex-col items-stretch justify-center overflow-hidden pt-16 sm:pt-20 md:pt-24 lg:pt-28 pb-10 sm:pb-12 md:pb-16"
    >
        ...
        >
          ...
          >
            <div className="glass-card p-8 rounded-xl border border-border relative overflow-hidden">
              ...
              <p className="text-muted-foreground text-sm md:text-base">Software as a Service</p>
            </div>

            <span className="mt-4 text-xs text-muted-foreground uppercase tracking-wider">The Old Way</span>
          </motion.div>
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                animate={{
                  borderColor:
                    animationPhase === 'swas' ? 'rgba(14, 165, 233, 0.8)' : 'rgba(14, 165, 233, 0.3)',
                  boxShadow:
                    animationPhase === 'swas'
